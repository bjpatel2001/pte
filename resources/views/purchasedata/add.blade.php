                            ...
                            <form action="{{url('/purchase/store')}}" name="app_add_form" id="app_form" style="border-radius: 0px;" method="post" class="form-horizontal group-border-dashed">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="purchase_date" id="purchase_date" placeholder="Purchase Date" class="form-control input-sm required" value="{{old('purchase_date')}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="received_date" id="received_date" placeholder="Received Date" class="form-control input-sm required" value="{{old('received_date')}}" />
                                    </div>
                                </div>
