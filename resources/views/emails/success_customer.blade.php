    ...
    <tr>
        <td>
            <table style="width:536px; font-size:20px;">
                <tr>
                    <td style="border-bottom:5px solid #008fd5; padding:20px 0; background-color:#CCC;" ><img src="http://ptevouchercode.com/images/logo.png" /></td>
                </tr>
                <tr>
                    <td>
    ...
    <tr>
        <td>
            <table style="width:536px; background-color:#ccc; border-top:5px solid #6d9d31; font-size:20px;">
                <tr style="text-align:left;">
                    <td width="110px"><img src="http://ptevouchercode.com/images/honor.png" style="height:100px; width:100px; border-radius:50%;"  /></td>
